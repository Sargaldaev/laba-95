  ...
  await Cocktail.create(
    {
      ...
      name: 'Aperol Syringe',
      recipe:
        'Fill a wine glass with ice. Pour 100 ml prosecco and 100 ml aperol into a glass.  Add a splash ' +
    ...
    },
    {
      ...
      name: 'Mojito',
      recipe:
        'Put 3 slices of lime in a highball and crush it with a mudler. Take 10 mint leaves in one hand ' +
    ...
    },
    {
      ...
      name: 'Margarita',
      recipe:
        'Make a salty rim on the margarita glass. Pour 30 ml lime juice, 10 ml sugar syrup, 25 ml triple' +
    ...
    },
    {
      ...
      name: 'Jin Tonik',
      recipe:
        'Fill the highball with ice cubes to the top. Pour 50 ml gin. Add the tonic to the top and ' +
    ...
    },
    {
      ...
      name: 'Daiquiri',
      recipe:
        'Pour 30 ml lime juice, 15 ml sugar syrup and 60 ml white rum into a shaker. Fill the shaker ' +
    ...
    },
    {
      ...
      name: 'Blue Lagoon',
      recipe:
        'Fill the hurricane with ice cubes to the top. Pour 20 ml blue curacao liqueur and 50 ml' +
    ...
    },
    {
      ...
      recipe:
        'Fill the sling with ice cubes to the top. Pour cranberry juice 40 ml, pineapple juice' +
    ...
    },
    {
      ...
      name: 'B-52',
      recipe:
        'Pour 15 ml of coffee liqueur into the stack. Using a cocktail spoon, lay a layer of Irish' +
    ...
    },
    {
      ...
      name: 'Cosmopolitan',
      recipe:
        'Pour 10 ml lime juice, 50 ml cranberry juice, 20 ml triple sec liqueur and 40 ml citrus vodka' +
    ...
    },
    {
      ...
      name: 'Cuba Libre',
      recipe:
        'Fill the highball with ice cubes to the top. Pour 10 ml lime juice and 50 ml golden rum.' +
    ...
    },
    {
      ...
      name: 'Bellini',
      recipe:
        'Put 4 tablespoons of peach puree in a mixing glass. Add lemon juice 10 ml, sugar syrup 10 ml and' +
    ...
    },
    {
      ...
      name: 'Manhattan',
      recipe:
        'Pour 25 ml red vermouth and 50 ml bourbon into a mixing glass. Add angostura bitter 1 dash.' +
    ...
    },
    {
      ...
      name: 'Screwdriver',
      recipe:
        'Fill Collins with ice cubes to the top. Pour 50 ml of vodka. Add orange juice to the top and' +
